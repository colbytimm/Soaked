...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="soaked_WatchKit_Extension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC25soaked_WatchKit_Extension22ComplicationController")
...
SWIFT_CLASS("_TtC25soaked_WatchKit_Extension17ExtensionDelegate")
...
SWIFT_CLASS("_TtC25soaked_WatchKit_Extension19InterfaceController")
...
SWIFT_CLASS("_TtC25soaked_WatchKit_Extension22NotificationController")
